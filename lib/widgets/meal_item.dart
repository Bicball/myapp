...
class MealItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      elevation: 2,
      child: InkWell(
        //O Inkwell nos fornecerá a propriedade de clicar
        onTap: () {
          onSelectedMeal(meal);
        },
        child: Stack(
          //Esse  widget permite organizar widgets sobrepondoos
          children: [
            FadeInImage(
            ...
            Positioned(
              //Cria um widget que controla onde o filho da pilha será alinhado
              bottom: 0,
              left: 0,
              right: 0,
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        MealItemTrait(
                          //Aqui usaremos um code injection em vez de converter meal.duration (int) em string
                          icon: Icons.schedule,
